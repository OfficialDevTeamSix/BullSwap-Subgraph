...
export class BullFactory extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save BullFactory entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save BullFactory entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("BullFactory", id.toString(), this);
  }

  static load(id: string): BullFactory | null {
    return store.get("BullFactory", id) as BullFactory | null;
  }
...
export class BullDayData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save BullDayData entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save BullDayData entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("BullDayData", id.toString(), this);
  }

  static load(id: string): BullDayData | null {
    return store.get("BullDayData", id) as BullDayData | null;
  }
